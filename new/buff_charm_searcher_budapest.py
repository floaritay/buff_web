    ...
    def get_charms(self, page_num: int = 1, page_size: int = 20) -> List[Dict]:
        ...
        try:
            ...
            params = {
                ...
                "page_num": page_num,
                "page_size": page_size,
                "category": "csgo_tool_keychain_budapest_2025",  # 挂件（纪念品）分类参数
                "sort_by": "price.asc"
            }
...
if __name__ == "__main__":
    ...
    # 运行脚本，设置最大购买价格为0.3，最大购买数量为5，最大页数为15页（共18页）
    searcher.run(max_price=0.2, max_pages=15, max_items=10, tried_items=tried_items)
